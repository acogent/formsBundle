...
class generateFixturesCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('sgn:generate:fixtures')
             ->setDescription("Generer des fixtures des entites d'un bundle")
             ->addArgument('bundle', InputArgument::REQUIRED, 'Pour quel bundle voulez-vous generer des fixtures ?')
             ;
    }
